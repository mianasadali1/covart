...
open class CameraViewController: UIViewController,FMImageEditorViewControllerDelegate {
    ...
    let swapButton : UIButton = {
        let button = UIButton()
        button.translatesAutoresizingMaskIntoConstraints = false
        button.setImage(UIImage(named: "swapButton1",
                                in: CameraGlobals.shared.bundle,
                                compatibleWith: nil),
                        for: .normal)
        return button
    ...
    let flashButton : UIButton = {
        ...
        button.translatesAutoresizingMaskIntoConstraints = false
        button.setImage(UIImage(named: "flashAutoIcon1",
                                in: CameraGlobals.shared.bundle,
                                compatibleWith: nil),
                        for: .normal)
        return button
    ...
    private func setupActions() {
        ...
        swapButton.action = { }
        libraryButton.action = { [weak self] in self?.swapCamera() }
