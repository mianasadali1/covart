...
@objc public protocol MaterialColorListDataSource {
  /**
...
@objc public protocol MaterialColorListDelegate{
  /**
  ...
  /**
   ...
   - returns: CGSize
   */
  @objc optional func sizeForCellAtIndex(_ materialColorPickerView: MaterialColorList, index: Int)->CGSize
}

open class MaterialColorList: UIView, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout{
  ...
  @objc dynamic open var dataSource: MaterialColorListDataSource?{
    didSet{
  ...
  @objc dynamic open var delegate: MaterialColorListDelegate?
