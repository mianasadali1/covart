...
- (void)setBlendMenu
{
    ...
    for(NSDictionary *obj in _menu){
        ...
        view.tag = tag++;
        view.iconView.image     =   [UIImage imageNamed:obj[@"title"]];
...
-(void)setPatternMenu{
    ...
    view.titleLabel.text    =   @"No Patteren";
...
- (UIImage*)circleBlurImage:(UIImage*)image withBlurImage:(UIImage*)blurImage{
    ...
    NSString *imgName   =   [NSString stringWithFormat:@"m%ld",overlayPattern];
